...
В данный момент компонент синхронизирует без учета даты в ределах +-12 часов. Т.е. если точное время 00:00:00, а время на ПУ 13:00:00, то коррекция будет +29 сек. А если время на ПУ 11:30:00 - то коррекция -29 сек.

*Коррекция с учетом даты - в разработке*
